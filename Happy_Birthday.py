...
def write_birthday_inside_circle(text_color, x, y):
    ...
    my_turtle_cursor.begin_fill()
    my_turtle_cursor.pendown()
    my_turtle_cursor.write("Nanda Acuu", font=("sans-serif", 22, "bold"))
    my_turtle_cursor.getscreen().update()
...
draw_layer_of_the_cake("#FFC0CB", "#000000", 3, -220,
                       y_coordinate - 70, 400, 10)
...
write_birthday_inside_circle("#000000", -80, y_coordinate + 200)
